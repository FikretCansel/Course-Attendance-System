    ...
    <section className="hero has-background-primary-25">
      <style jsx>{`
        .navbar-item.has-dropdown.is-hoverable .navbar-dropdown {
          left: auto; /* Profil dropdown'u sağa hizalayın */
          right: 0;
        }

        .navbar-item.has-dropdown.is-hoverable .navbar-dropdown .navbar-item {
          white-space: normal; /* Mail adresinin taşmamasını sağlamak için */
        ...
        .navbar-item.has-dropdown.is-hoverable .navbar-dropdown .navbar-item p {
          margin-bottom: 0; /* Profil dropdown öğeleri arasındaki boşluğu ayarlamak için */
        }
      `}</style>
          ...
          <div className="navbar-end">
            <div className="navbar-item">
              <div className="buthrefns">
                <div className="navbar-item has-dropdown is-hoverable">
                  <p className="navbar-link" onClick={() => setIsActive(false)}>Profil</p>
                  <div className="navbar-dropdown">
